package com.example.user.lab43sqlite;
...
import com.example.user.lab43sqlite.Model.Course;
...
public class AddActivity extends AppCompatActivity {
    ...
    public void saveRecord(View v) {
        ...
        if(code.isEmpty()) {
            editTextCode.setError("Where code? OmegaLUL");
            return;
        }
        title = editTextTitle.getText().toString();
        if(title.isEmpty()) {
            editTextTitle.setError("Where title? UltraLUL");
            return;
        }
        credit = editTextCredit.getText().toString();
        if(credit.isEmpty()) {
            editTextCredit.setError("Where credit? InfinityLUL");
            return;
        }
